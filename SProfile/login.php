        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to AU CEG Placement Platform</h2>
              <hr>
              <p> 
            ...
            <div class="templatemo-content-widget white-bg col-1 text-center">
              ...
              <h5 class="text-uppercase margin-bottom-10"> Datascience</h5>
              <img src="images/a1.jpg" alt="Bicycle" class="img-square img-thumbnail">
            </div>
          ...
          <div class="templatemo-flex-row flex-content-row">
            <div class="col-1">
              <div class="templatemo-content-widget brown-bg">
                <i class="fa fa-times"></i>
                <div class="media">
                  <div class="media-left">
                    <a href="#">
                      <img class="media-object img-square" src="images/a5.webp" alt="Sunset">
                    </a>
                  </div>
