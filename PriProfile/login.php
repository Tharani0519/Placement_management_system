        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome AU CEG</h2><hr>
              <p>Have a view at the Student details and their eligibility criteria,company details and campus drives.</p>
          ...
          <div class="templatemo-content-widget white-bg col-1 text-center">
              <i class="fa fa-times"></i>
              <h2 class="text-uppercase">Finest Project</h2>
              <h3 class="text-uppercase margin-bottom-10">Machine learning</h3>
              <img src="images/pic4.jpg" alt="Bicycle" class="img-square img-thumbnail"> 
            </div>
            <div class="templatemo-content-widget white-bg col-1">
              <i class="fa fa-times"></i>
              <h2 class="text-uppercase"> College Progress</h2>
              <h3 class="text-uppercase">Year Wise</h3><hr>
              <div class="progress">
            ...
            <div class="col-1">
              <div class="templatemo-content-widget orange-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>Get the recent eligibility criteria
              ...
              <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="#">
                      <!--<img class="media-object img-square" src="images/y1.jpg" alt="Sunset">-->
                    </a>
                  </div>
                  <div class="media-body">
                    <h2 class="media-heading text-uppercase">Details</h2>
