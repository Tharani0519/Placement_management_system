...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
	...
	<body>
					...
					<div class="top-nav">
						...
						<ul class="nav1">
							...
							<li class="hvr-sweep-to-bottom active">
								<a href="index.php">Home<i>Overview of the Site</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
								<a href="about.php">About<i>About Us & our excellence in placements</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
								<a href="../products.php">Placement hub<i>Campus Drives</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
				...
				<div id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							...
							<h2>Enrich your Brain with <span>Sleek efforts</span> &
						...
						<li>
							<div class="banner-info">
							<h2><span>Believe</span> you can and you're halfway there </h2>
		...
		<div class="specialty">
			...
			<div class="container">
				<div class="col-md-5 specialty-info wow fadeInLeft animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					...
					<p>
					We are here to simply and manage your placements in an intuitive and efficient way .Every year we help more than thousands of students to grab placemnts in a better way using our Placement Platform board.
					</p>
				...
				<div class="col-md-7 specialty-grids">
					<div class="specialty-grids-top">
						<div class="col-md-6 service-box wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
							...
							<h5><b>Skill Building</b></h5>
							<p>The expert in anything was once a beginner, Start improving your skills to get greater placements.</p>
						</div>
						<div class="col-md-6 service-box wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
							<figure class="icon">
								<img src="images/2.png" alt="" />
							</figure>
							<h5><b>Company Drives</b></h5>
							<p>Find out the upcoming and ongoing companies for placements.</p>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="specialty-grids-top">
						<div class="col-md-6 service-box wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
							...
							<h5><b>Innovation and Creativity</b></h5>
							<p>Predict your future success with your innovations & creativity .</p>
						</div>
						<div class="col-md-6 service-box wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
							<figure class="icon">
								<img src="images/4.png" alt="" />
							</figure>
							<h5><b>Excellence</b></h5>
							<p>May you excel in your career with a better placements.</p>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
			...
			<div class="container">
				...
				<!--<div class="testimonial-grids wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">-->
					<div class="testimonial-grid">
						<p>
							<span>"</span> Your Success is our satisfaction 
							<span>"</span>
						</p>
					</div>
				</div>
		...
		<div class="footer">
			<!-- container -->
			<div class="container">
				<div class="col-md-6 footer-left  wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.2s;">
					<ul>
						<li>
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>AU , COLLEGE OF ENGINEERING GUINDY
							<span>Chennai,Tamil Nadu</span>
						</p>
					</div>
					<div class="phone">
						<p>044 - 2235 7080 / 81</p>
					</div>
				</div>
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<h4>
						<a href="../Homepage/index.php" style="color: white"></a>
					</h4>
					<p></p>
				</div>
				<div class="clearfix"></div>
