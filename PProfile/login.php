          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
               <li><a href="../Drives/index.php">Home AUU CEG</a></li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to CEG Placement Platform</h2>
              <p></p>
              <p>Hello Officer! You can add drives, Send Notifications and View the Eligibility Criteria of Students.</p>
            ...
            <div class="templatemo-content-widget white-bg col-1 text-center">
              ...
              <img src="images/a2.jpg" alt="White" class="img-square img-thumbnail"> 
            </div>
            <div class="templatemo-content-widget white-bg col-1">
              <i class="fa fa-times"></i>
              <h2 class="text-uppercase"></h2>
              <h3 class="text-uppercase">Our progress </h3><hr>
              <div class="progress">
