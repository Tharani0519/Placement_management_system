    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <div class="profile-photo-container">
         <!-- <img src="images/.jpg" alt="Profile Photo" class="img-responsive">-->
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to placement platform of CEG</h2><hr>
              <p>Have a view at the details of students and the campus drives.</p>
            ...
            <div class="templatemo-content-widget white-bg col-1 text-center">
              ...
              <h6 class="text-uppercase margin-bottom-10">WEB DESIGN</h6>
           <img src="images/pic6.jpg" alt="Bicycle" class="img-square img-thumbnail"> 
            </div>
            <div class="templatemo-content-widget white-bg col-1">
              <i class="fa fa-times"></i>
              <h2 class="text-uppercase">PLACEMENT </h2>
            ...
            <div class="col-1">
              <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="#">
                      <img class="media-object img-square" src="images/a2.jpg" alt="Sunset">
                    </a>
                  </div>
                  <div class="media-body">
                    <h2 class="media-heading text-uppercase"><b> Latest Happenings </b></h2><br>
                    <p><b>5+ companies will be offering intern this month</b></p>
                  </div>
              ...
              <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="#">
                      <img class="media-object img-circle" src="images/a1.jpg" alt="Sunset">
                    </a>
                  </div>
                  <div class="media-body">
                    <h2 class="media-heading text-uppercase"><b>Accomplishment</b></h2><br>
                    <p><b>Highest package this year has crossed all our previous year benchmarks</b></p>
                  </div>
                </div>
              </div>
            </div>
